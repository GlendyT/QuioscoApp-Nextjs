/*
  ...
  - You are about to drop the column `productoId` on the `OrderProducts` table. All the data in the column will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "OrderProducts" DROP CONSTRAINT "OrderProducts_productoId_fkey";

-- AlterTable
ALTER TABLE "OrderProducts" DROP COLUMN "productoId",
